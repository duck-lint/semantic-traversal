...
| Redacted report conceals deterministic mismatches | Aggregate exposes only first-turn plan status | Redacted v4 includes safe per-turn component statuses and case aggregation over every turn |
