...
def _validate_schema(connection: sqlite3.Connection) -> None:
    ...
    if _table_columns(connection, "conversations") != _CONVERSATION_COLUMNS:
        raise RuntimeConversationError("runtime conversations schema is incompatible")
    if _table_columns(connection, "messages") != _MESSAGE_COLUMNS:
        raise RuntimeConversationError("runtime messages schema is incompatible")
